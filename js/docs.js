...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0,_jquery2.default)('#single, #select-multiple').select2({placeholder:'Select a State',allowClear:true}).on('select2-open',function(){var $this=(0,_jquery2.default)(this);if($this.parents('[class*="has-"]').length){// get all CSS-classes from the element where we found "has-*" and collect them in an array
